...
export class GestionBenevolesComponent implements OnChanges {
  ...
  send(benevole:Benevole){
      this.benevoleService.updateReponse(benevole).subscribe(data => {
        ...
        this.email.text =  this.email.text + "<br>Vous pourrez bien entendu retrouver cette réponse sur <a href='https://kermess.herokuapp.com'>le site d'inscription</a><br>Cordialement,<br>L'équipe d'animation"
